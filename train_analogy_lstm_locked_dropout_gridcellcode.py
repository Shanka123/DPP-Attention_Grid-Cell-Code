...
class LSTM(nn.Module):
	...
	def forward(self, x_seq, device):
		...
		# Apply LSTM
		lstm_out, (hidden, cell_state) = self.lstm(self.dropout(x_seq), (hidden, cell_state))
...
def main():
	...
	parser.add_argument('--model_name', type=str, default='analogy_locked_dropout_gridcellcode_lstm_module' )
